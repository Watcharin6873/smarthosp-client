...
const FormEvaluatePeople = () => {
  ...
  const questData = listQuest.filter(item => item.category_questId === 4)
  ...
  return (
    <div>
      <div className='flex justify-center items-center text-2xl font-bold mb-8 text-green-600'>
        <p className='ml-2'>ประเมินผลด้านบุคลากร (People)</p>
      </div>
      ...
      <div className='bg-white rounded-md shadow-md p-3'>
        ...
        >
          ...
          >
            ...
            >
              <Upload customRequest={({ onSuccess }) => onSuccess('ok')} {...props}>
                <Button>
                  <UploadOutlined /> แนบไฟล์ .pdf ขนาดไม่เกิน 15 MB
                </Button>
              </Upload>
            </Form.Item>
          </Form>
...
export default FormEvaluatePeople